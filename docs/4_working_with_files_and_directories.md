...
![](images/rwx_figure.svg){alt='Permissions breakdown'}
...
!!! dumbbell "Exercise"
    ...
    ??? success "Solution"
        ...
        4. `chmod -w backup/*-backup.fastq`  
         ...
         ```output
         -r--r--r-- 1 user group 47552 Nov 15 23:06 SRR097977-backup.fastq
         -r--r--r-- 1 user group 43332 Nov 15 23:06 SRR098026-backup.fastq
         ```
